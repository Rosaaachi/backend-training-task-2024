...
const yogaGroup = 300;
const weightTrainGroup = 500;
const weightTrainPrivate = 1500;
const canUseMoney = 3000;
...
AlexBudget = weightTrainGroup*1 +yogaGroup*3 + weightTrainPrivate*1;

console.log(`Alex 買完課程了，他一共剩下 ${canUseMoney-AlexBudget} 元`);

// ### 題目四：線稿圖截圖，看圖宣告變數
// 請參考資料夾內 q4.webp 圖片
// 請依照你看到的內容來嘗試設計變數和值（至少 3 個）

const for14Classes =  2520;
const timeOfclass = 50;
let discount = 0.9;
...
let numberArr1 = [5, 10, 15]; //宣告變數為新陣列
let numberArr2 = numberArr1;  //宣告一個新陣列，指向到與numberArr1一樣的記憶體空間（傳參考）
numberArr2.push(20);          //在陣列的最後新增20的值
numberArr2 = [25, 30, 35];    //變更陣列內容為[25, 30, 35]
console.log(numberArr1, numberArr2); //25, 30, 35,25, 30, 35
