...
var l = '8';
// 請文字解釋為什麼
console.log(k * l > 21);// true, 會自動轉變成數字類型
...
if(coachIncome<100000){
  coachBonus = coachIncome*0.1 + baseBonus;
}else if(coachIncome>=100000 && coachIncome < 300000){
  coachBonus = coachIncome*0.15 + baseBonus;
}else{ coachBonus = coachIncome * 0.2 + baseBonus;
};
...
const activities = {
  ...
  runningMachine:{
    name: "跑步機",
    calorieBurnPerMinute: 10
  },

  yoga:{
    name: "瑜伽",
    calorieBurnPerMinute: 5
  },
...
calorieBurn += activities.cycling.calorieBurnPerMinute*10;
calorieBurn += activities.runningMachine*30;
calorieBurn += activities.yoga.calorieBurnPerMinute*40;
calorieBurn += activities.cycling.calorieBurnPerMinute*10;
